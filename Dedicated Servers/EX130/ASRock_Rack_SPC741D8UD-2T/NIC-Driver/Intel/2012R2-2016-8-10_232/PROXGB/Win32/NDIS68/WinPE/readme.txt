...
 
32-bit Microsoft Windows PE V1
==============================
1. Create a temporary directory (for example, c:\temp\winpe).
 
2. Copy all files from the PROXGB\Win32\NDIS68\WinPE directory to the temporary
   directory.
 
3. Extract the driver inf file (for example: ixe6832.inf) from
   PROXGB\Win32\NDIS68\WinPE\*.zip to the temporary directory.
 
...
 
   dism /image:C:\mounted_winpe /Add-Driver /driver:c:\temp\winpe\ixe6832.inf
 
...
 
x64 Microsoft Windows PE V1
===========================
1. Create a temporary directory (for example, c:\temp\winpe).
 
2. Copy all files from the PROXGB\Winx64\NDIS68 directory to the temporary
   directory. Do NOT copy the ixe68x64.inf file to this directory.
 
3. Extract the driver inf file (for example: ixe68x64.inf)from 
